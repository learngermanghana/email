...
with tabs[9]:
    ...
    chosen = st.selectbox("Select a student", student_list)
    ...
    hist = scores_df[
        scores_df['StudentCode'].str.lower() == student_row['studentcode'].lower()
    ]
    if not hist.empty:
