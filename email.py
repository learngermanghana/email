...
with tabs[9]:
    ...
    ref_answers = {
        ...
        # ... (add/continue more as needed) ...
        "A2 10.28. Über die Zukunft sprechen": [
            "1. c) Einen gültigen Reisepass", "2. b) Bei der Deutschen Botschaft im Heimatland", "3. c) Einen Aufenthaltstitel",
            "4. b) Ein Kurs für Deutsch und Leben in Deutschland", "5. c) Man muss sie übersetzen und anerkennen lassen",
            "6. c) Die Arbeitsagentur", "7. c) Kranken-, Renten- und Pflegeversicherung"
        ]
    }
